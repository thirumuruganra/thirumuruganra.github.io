...
export function ContactWindow() {
  return (
    <div className="space-y-5">
      <h2 className="font-display text-base">Mail</h2>
      ...
      <a
        ...
        className="flex items-center justify-center gap-3 w-full pixel-border rounded-[14px] p-4 bg-pixel-accent text-black font-display text-xs sm:text-sm hover:translate-x-0.5 hover:translate-y-0.5 active:translate-x-1 active:translate-y-1 transition-transform"
      >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="flex items-center justify-between p-3 pixel-border-2 rounded-[12px] bg-pixel-window hover:bg-pixel-titlebar"
        >
